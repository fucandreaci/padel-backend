...
@AllArgsConstructor
@NoArgsConstructor
public class Regola implements JsonParsable{
    private String nome;
    ...
    public void parseJson(JSONObject json) throws GenericException {
        try {
            ...
            throw new ParseException("Errore nel parsing delle regole", HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
}
